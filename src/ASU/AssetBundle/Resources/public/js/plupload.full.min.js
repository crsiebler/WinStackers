/*1.5.5*/(function() {
    ...
    var h = {VERSION: "1.5.5", STOPPED: 1, STARTED: 2, QUEUED: 1, UPLOADING: 2, FAILED: 4, DONE: 5, GENERIC_ERROR: -100, HTTP_ERROR: -200, IO_ERROR: -300, SECURITY_ERROR: -400, INIT_ERROR: -500, FILE_SIZE_ERROR: -600, FILE_EXTENSION_ERROR: -601, IMAGE_FORMAT_ERROR: -700, IMAGE_MEMORY_ERROR: -701, IMAGE_DIMENSIONS_ERROR: -702, mimeTypes: r, ua: function() {
            var e = navigator, t = e.userAgent, n = e.vendor, r, i, s;
            r = /WebKit/.test(t);
            s = r && n.indexOf("Apple") !== -1;
            i = window.opera && window.opera.buildNumber;
            return{windows: navigator.platform.indexOf("Win") !== -1, ie: !r && !i && /MSIE/gi.test(t) && /Explorer/gi.test(e.appName), webkit: r, gecko: !r && /Gecko/.test(t), safari: s, opera: !!i}
        }(), typeOf: function(e) {
            ...
            for (n = 0; n < 5; n++)
                t += Math.floor(Math.random() * 65535).toString(32);
            ...
            if (e) {
                ...
                if (n === o) {
                    for (r in e)
                        if (e.hasOwnProperty(r) && t(e[r], r) === !1)
                            return
                } else
                    for (i = 0; i < n; i++)
                        if (t(e[i], i) === !1)
    ...
    h.Uploader = function(e) {
        ...
        function l() {
            ...
            if (r.size === o)
                r.percent = i.length > 0 ? Math.ceil(r.uploaded / i.length * 100) : 0;
            else {
        ...
        e = h.extend({chunk_size: 0, multipart: !0, multi_selection: !0, file_data_name: "file", filters: []}, e);
        h.extend(this, {state: h.STOPPED, runtime: "", features: {}, files: i, settings: e, total: r, id: h.guid(), init: function() {
                function v() {
                    var e = a[p++], t, r, i;
                    if (e) {
                        t = e.getFeatures();
                        ...
                        n.trigger("Error", {code: h.INIT_ERROR, message: h.translate("Init error.")})
                }
                ...
                n.bind("StateChanged", function(e) {
                    if (e.state == h.STARTED)
                        s = +(new Date);
                    else if (e.state == h.STOPPED)
                        for (r = e.files.length - 1; r >= 0; r--)
                            if (e.files[r].status == h.UPLOADING) {
                ...
                if (t) {
                    ...
                    for (r = 0; r < t.length; r++)
                        if (t[r].func.apply(t[r].scope, i) === !1)
                            return!1
                }
                return!0
...
(function() {
    ...
    google.gears || (google.gears = {factory: e})
})();
(function(e, t, n, r) {
    function s(e, t, n) {
        var r, i, s, o;
        ...
        try {
            ...
            o = Math.min(t.width / i.width, t.height / i.height);
            if (o < 1)
                i.resize(Math.round(i.width * o), Math.round(i.height * o));
            else if (!t.quality || n !== "image/jpeg")
                return e;
            return t.quality ? i.encode(n, {quality: t.quality / 100}) : i.encode(n)
        } catch (u) {
        }
        return e
    }
    ...
    n.runtimes.Gears = n.addRuntime("gears", {getFeatures: function() {
            ...
            r.bind("PostInit", function() {
                ...
                n.addEvent(t.getElementById(e.browse_button), "click", function(t) {
                    ...
                    u.openFiles(d, {singleFile: !e.multi_selection, filter: n})
                }, r.id)
            });
            ...
            r.bind("UploadFile", function(e, t) {
                function v() {
                    ...
                    var s, a = e.settings.multipart, p = 0, m = {name: t.target_name || t.name}, g = e.settings.url;
                    if (t.status == n.DONE || t.status == n.FAILED || e.state == n.STOPPED)
                        return;
                    if (d) {
                        m.chunk = r;
                        m.chunks = o
                    ...
                    l.onreadystatechange = function() {
                        ...
                        if (l.readyState == 4 && e.state !== n.STOPPED)
                            if (l.status == 200) {
                                i = {chunk: r, chunks: o, response: l.responseText, status: l.status};
                                ...
                                if (++r >= o) {
                                    t.status = n.DONE;
                                    e.trigger("FileUploaded", t, {response: l.responseText, status: l.status})
                                } else
                                    v()
                            } else
                                e.trigger("Error", {code: n.HTTP_ERROR, message: n.translate("HTTP Error."), file: t, chunk: r, chunks: o, status: l.status})
                    };
            ...
            r.bind("Destroy", function(e) {
                var r, i, s = {browseButton: e.settings.browse_button, dropElm: e.settings.drop_element};
                for (r in s) {
...
(function(e, t, n, r) {
    ...
    var i = {}, s = {};
    n.silverlight = {trigger: function(e, t) {
            var r = i[e], s, o;
            if (r) {
    ...
    n.runtimes.Silverlight = n.addRuntime("silverlight", {getFeatures: function() {
            return{jpgresize: !0, pngresize: !0, chunks: !0, progress: !0, multipart: !0, multi_selection: !0}
        }, init: function(r, l) {
            function E() {
            ...
            n.extend(p.style, {position: "absolute", top: "0px", background: r.settings.shim_bgcolor || "transparent", zIndex: 99999, width: "100px", height: "100px", overflow: "hidden", opacity: r.settings.shim_bgcolor || t.documentMode > 8 ? "" : .01});
            ...
            for (y = 0; y < m.length; y++)
                v += (v != "" ? "|" : "") + m[y].title + " | *." + m[y].extensions.replace(/,/g, ";*.");
            ...
            r.bind("Silverlight:Init", function() {
                ...
                r.bind("Silverlight:UploadChunkError", function(e, t, i, s, o) {
                    r.trigger("Error", {code: n.IO_ERROR, message: "IO Error.", details: o, file: e.getFile(u[t])})
                });
...
(function(e, t, n, r) {
    ...
    n.runtimes.Flash = n.addRuntime("flash", {getFeatures: function() {
            ...
            n.extend(f.style, {position: "absolute", top: "0px", background: e.settings.shim_bgcolor || "transparent", zIndex: 99999, width: "100%", height: "100%"});
            ...
            e.bind("Flash:Init", function() {
                ...
                e.bind("Refresh", function(r) {
                    ...
                    if (i) {
                        ...
                        o = n.getSize(i);
                        n.extend(t.getElementById(r.id + "_flash_container").style, {top: s.y + "px", left: s.x + "px", width: o.w + "px", height: o.h + "px"})
                    }
                });
...
(function(e) {
    e.runtimes.BrowserPlus = e.addRuntime("browserplus", {getFeatures: function() {
            ...
            function f() {
                ...
                t.bind("PostInit", function() {
                    ...
                    if (l)
                        if (document.attachEvent && /MSIE/gi.test(navigator.userAgent)) {
                            ...
                            n.setAttribute("id", o);
                            e.extend(n.style, {position: "absolute", top: "-1000px", background: "red", filter: "alpha(opacity=0)", opacity: 0});
                            document.body.appendChild(n);
                            e.addEvent(l, "dragenter", function(t) {
                                var n, r;
                                n = document.getElementById(i);
                                r = e.getPos(n);
                                e.extend(document.getElementById(o).style, {top: r.y + "px", left: r.x + "px", width: n.offsetWidth + "px", height: n.offsetHeight + "px"})
                            });
                            h(o, p)
                        } else
                            h(i);
                ...
                t.bind("UploadFile", function(t, n) {
                    function d(i, s) {
                        ...
                        o = p.shift();
                        r.Uploader.upload({url: t.settings.url, files: {file: o}, cookies: document.cookies, postvars: e.extend(u, t.settings.multipart_params), progressCallback: function(e) {
                                var r, s = 0;
                            ...
                            if (r.success) {
                                ...
                                f && t.trigger("ChunkUploaded", n, {chunk: i, chunks: s, response: r.value.body, status: o});
                                if (p.length > 0)
                                    d(++i, s);
                                else {
                                    n.status = e.DONE;
                                    t.trigger("FileUploaded", n, {response: r.value.body, status: o});
                                    o >= 400 && t.trigger("Error", {code: e.HTTP_ERROR, message: e.translate("HTTP Error."), file: n, status: o})
                                }
                            } else
                                t.trigger("Error", {code: e.GENERIC_ERROR, message: e.translate("Generic Error."), file: n, details: r.error})
                        })
                    }
                    function v(e) {
                        n.size = e.size;
                        if (f)
                            r.FileAccess.chunk({file: e, chunkSize: f}, function(e) {
                                if (e.success) {
                    ...
                    o && /\.(png|jpg|jpeg)$/i.test(n.name) ? BrowserPlus.ImageAlter.transform({file: s, quality: o.quality || 90, actions: [{scale: {maxwidth: o.width, maxheight: o.height}}]}, function(e) {
            ...
            r ? r.init(function(e) {
                var t = [{service: "Uploader", version: "3"}, {service: "DragAndDrop", version: "1"}, {service: "FileBrowse", version: "1"}, {service: "FileAccess", version: "2"}];
                o && t.push({service: "ImageAlter", version: "4"});
                e.success ? r.require({services: t}, function(e) {
                    e.success ? f() : n()
                }) : n()
            }) : n()
        }})
...
(function(e, t, n, r) {
    ...
    function l() {
        function n(n, r) {
            ...
            for (o = 0; o < r; o++)
                s |= t.charCodeAt(n + o) << Math.abs(i + o * 8);
            return s
        }
        function i(e, n, r) {
        ...
        function s(t, n, r) {
            var s = "", o = e ? 0 : -8 * (r - 1), u;
            for (u = 0; u < r; u++)
                s += String.fromCharCode(n >> Math.abs(o + u * 8) & 255);
            i(s, t, r)
        }
        var e = !1, t;
    ...
    function c(e) {
        ...
        while (s <= a) {
            ...
            if (o === 65498 || o === 65497)
                break;
            u = i.SHORT(s + 2) + 2;
            t[o] && i.STRING(s + 4, t[o].signature.length) === t[o].signature && n.push({hex: o, app: t[o].app.toUpperCase(), name: t[o].name.toUpperCase(), start: s, length: u, segment: i.SEGMENT(s, u)});
            s += u
        }
        i.init(null);
        return{headers: n, restore: function(e) {
                i.init(e);
                var t = new c(e);
                if (!t.headers)
                    return!1;
                ...
                for (var r = 0, i = n.length; r < i; r++)
                    n[r].app === e.toUpperCase() && t.push(n[r].segment);
                return t
            }, set: function(e, t) {
                var r = [];
    ...
    function h() {
            ...
            for (u = 0; u < i; u++) {
                ...
                switch (l) {
                    ...
                    case 5:
                        ...
                        for (a = 0; a < c; a++)
                            v[a] = e.LONG(p + a * 4) / e.LONG(p + a * 4 + 4);
                        break;
                    case 9:
                        p = e.LONG(p) + s.tiffHeader;
                        for (a = 0; a < c; a++)
                    ...
                    case 10:
                        p = e.LONG(p) + s.tiffHeader;
                        for (a = 0; a < c; a++)
                            v[a] = e.SLONG(p + a * 4) / e.SLONG(p + a * 4 + 4);
                        break;
                    default:
                        continue
                }
        ...
        return{init: function(t) {
                ...
                if (e.ExifVersion && n.typeOf(e.ExifVersion) === "array") {
                    for (var r = 0, i = ""; r < e.ExifVersion.length; r++)
                        i += String.fromCharCode(e.ExifVersion[r]);
                    e.ExifVersion = i
                }
                return e
            }, GPS: function() {
    ...
    n.runtimes.Html5 = n.addRuntime("html5", {getFeatures: function() {
            ...
            return{html5: i, dragdrop: function() {
            ...
            r.bind("Init", function(e) {
                ...
                n.extend(i.style, {position: "absolute", background: r.settings.shim_bgcolor || "transparent", width: "100px", height: "100px", overflow: "hidden", zIndex: 99999, opacity: r.settings.shim_bgcolor ? "" : 0});
                ...
                e.features.triggerDialog ? n.extend(v.style, {position: "absolute", width: "100%", height: "100%"}) : n.extend(v.style, {cssFloat: "right", styleFloat: "right"});
                v.onchange = function() {
                    c(this.files);
                    this.value = ""
                };
                ...
                if (e) {
                    if (o) {
                        n.addEvent(e, "dragenter", function(i) {
                            ...
                            u = n.getSize(e);
                            n.getStyle(e, "position") === "static" && n.extend(e.style, {position: "relative"});
                            n.extend(s.style, {position: "absolute", display: "block", top: 0, left: 0, width: u.w + "px", height: u.h + "px", opacity: 0})
                        }, r.id);
                        return
                    }
            ...
            r.bind("Refresh", function(e) {
                ...
                if (i) {
                    ...
                    n.extend(u.style, {top: s.y + "px", left: s.x + "px", width: o.w + "px", height: o.h + "px"});
                    if (r.features.triggerDialog) {
                        n.getStyle(i, "position") === "static" && n.extend(i.style, {position: "relative"});
                        a = parseInt(n.getStyle(i, "zIndex"), 10);
                        isNaN(a) && (a = 0);
                        n.extend(i.style, {zIndex: a});
                        n.extend(u.style, {zIndex: a - 1})
                    }
                }
            });
            ...
            r.bind("UploadFile", function(t, r) {
                function h(e, t, n) {
                    ...
                    if (!File.prototype.slice)
                        return(r = File.prototype.webkitSlice || File.prototype.mozSlice) ? r.call(e, t, n) : null;
                    try {
                        e.slice();
                        return e.slice(t, n)
                    } catch (i) {
                ...
                function p(s) {
                    function c() {
                        function S(i) {
                            ...
                            l.onreadystatechange = function() {
                                ...
                                if (l.readyState == 4 && t.state !== n.STOPPED) {
                                    ...
                                    if (e >= 400)
                                        t.trigger("Error", {code: n.HTTP_ERROR, message: n.translate("HTTP Error."), file: r, status: e});
                                    else {
                                        if (m) {
                                            s = {chunk: o, chunks: m, response: l.responseText, status: e};
                                        ...
                                        if (!m || ++o >= m) {
                                            r.status = n.DONE;
                                            t.trigger("FileUploaded", r, {response: l.responseText, status: e})
                                        } else
                                            c()
                                    }
                                }
                            ...
                            if (t.settings.multipart && u.multipart) {
                                ...
                                if (typeof i == "string") {
                                    ...
                                    if (l.sendAsBinary)
                                        l.sendAsBinary(i);
                                    else if (u.canSendBinary) {
                                        var x = new Uint8Array(i.length);
                                        for (var T = 0; T < i.length; T++)
                                            x[T] = i.charCodeAt(T) & 255;
                                        l.send(x.buffer)
                                    }
                                    return
                                }
                        ...
                        if (r.status == n.DONE || r.status == n.FAILED || t.state == n.STOPPED)
                            return;
                        g = {name: r.target_name || r.name};
...
(function(e, t, n, r) {
    ...
    n.runtimes.Html4 = n.addRuntime("html4", {getFeatures: function() {
            return{multipart: !0, triggerDialog: n.ua.gecko && e.FormData || n.ua.webkit}
        }, init: function(r, s) {
            r.bind("Init", function(s) {
                function T() {
                    ...
                    n.extend(u.style, {width: "100%", height: "100%", opacity: 0, fontSize: "99px", cursor: "pointer"});
                    n.extend(e.style, {overflow: "hidden"});
                    l = s.settings.shim_bgcolor;
                    l && (e.style.background = l);
                    m && n.extend(u.style, {filter: "alpha(opacity=0)"});
                ...
                function N() {
                    ...
                    n.addEvent(u, "load", function(t) {
                        ...
                        try {
                            ...
                            s.trigger("Error", {code: n.SECURITY_ERROR, message: n.translate("Security error."), file: c});
                            return
                        }
                        o = i.body.innerHTML;
                        if (o) {
                            ...
                            s.trigger("FileUploaded", c, {response: o})
                        }
                    }, s.id)
                }
                ...
                s.bind("UploadFile", function(e, r) {
                    var s, o;
                    if (r.status == n.DONE || r.status == n.FAILED || e.state == n.STOPPED)
                        return;
                    s = i("form_" + r.id);
                    o = i("input_" + r.id);
                    o.setAttribute("name", e.settings.file_data_name);
                    s.setAttribute("action", e.settings.url);
                    n.each(n.extend({name: r.target_name || r.name}, e.settings.multipart_params), function(e, r) {
                        var i = t.createElement("input");
                        n.extend(i, {type: "hidden", name: r, value: e});
                ...
                s.bind("Refresh", function(e) {
                    ...
                    if (r) {
                        ...
                        c = i("form_" + p);
                        h = i("input_" + p);
                        n.extend(c.style, {top: f.y + "px", left: f.x + "px", width: l.w + "px", height: l.h + "px"});
                        if (e.features.triggerDialog) {
                            n.getStyle(r, "position") === "static" && n.extend(r.style, {position: "relative"});
                            d = parseInt(r.style.zIndex, 10);
                            isNaN(d) && (d = 0);
                            n.extend(r.style, {zIndex: d});
                            n.extend(c.style, {zIndex: d - 1})
                        }
                ...
                r.bind("Destroy", function(e) {
                    var r, s, u, f = {inputContainer: "form_" + p, inputFile: "input_" + p, browseButton: e.settings.browse_button};
                    for (r in f) {
                        s = i(f[r]);
