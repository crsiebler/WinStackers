 ...
 */(function(e) {
    e.widget("ui.formwizard", {_init: function() {
            var t = this, n = this.options.formOptions.success, r = this.options.formOptions.complete, i = this.options.formOptions.beforeSend, s = this.options.formOptions.beforeSubmit, o = this.options.formOptions.beforeSerialize;
            ...
            if (this.options.validationEnabled && jQuery().validate == undefined) {
                ...
                this.options.validationEnabled && this.element.validate(this.options.validationOptions);
            ...
            if (this.options.remoteAjax != undefined) {
                var t = this.options.remoteAjax[this.currentStep], n = this;
                if (t !== undefined) {
                    var r = t.success, i = t.beforeSend, s = t.complete;
            ...
            this._disableNavigation();
            var r = this.steps.filter("#" + e), i = this.steps.filter("#" + t);
            ...
            var n = undefined, r = this.steps.filter("#" + t).find(this.options.linkClass);
            ...
            if (t != undefined)
                return t != "" && t != null && t != undefined && this.steps.filter("#" + t).attr("id") != undefined ? t : this.currentStep;
            if (t == undefined && !this.isLastStep) {
                var n = this.steps.filter("#" + e).next().attr("id");
                return n
            }
        }, _show: function(t) {
            var n = !1, r = t !== undefined;
            if (t == undefined || t == "") {
            ...
            if (this.currentStep !== t || t === this.firstStep) {
                ...
                this.currentStep = t;
                var i = function() {
                    r && e(this.element).trigger("step_shown", e.extend({isBackNavigation: n}, this._state()))
                };
                r && e(this.element).trigger("before_step_shown", e.extend({isBackNavigation: n}, this._state()));
        ...
        }, options: {historyEnabled: !1, validationEnabled: !1, validationOptions: undefined, formPluginEnabled: !1, linkClass: ".link", submitStepClass: "submit_step", back: ":reset", next: ":submit", textSubmit: "Submit", textNext: "Next", textBack: "Back", remoteAjax: undefined, inAnimation: {opacity: "show"}, outAnimation: {opacity: "hide"}, inDuration: 400, outDuration: 400, easing: "swing", focusFirstInput: !1, disableInputFields: !0, formOptions: {reset: !0, success: function(e) {
