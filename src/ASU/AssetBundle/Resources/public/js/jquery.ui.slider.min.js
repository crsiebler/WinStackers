 ...
 */(function(e, t) {
    ...
    e.widget("ui.slider", e.ui.mouse, {version: "1.10.0", widgetEventPrefix: "slide", options: {animate: !1, distance: 0, max: 100, min: 0, orientation: "horizontal", range: !1, step: 1, value: 0, values: null, change: null, slide: null, start: null, stop: null}, _create: function() {
            ...
            this.range = e([]);
            if (r.range) {
                r.range === !0 && (r.values ? r.values.length && r.values.length !== 2 ? r.values = [r.values[0], r.values[0]] : e.isArray(r.values) && (r.values = r.values.slice(0)) : r.values = [this._valueMin(), this._valueMin()]);
            ...
            this._clickOffset = f ? {left: 0, top: 0} : {left: t.pageX - a.left - s.width() / 2, top: t.pageY - a.top - s.height() / 2 - (parseInt(s.css("borderTopWidth"), 10) || 0) - (parseInt(s.css("borderBottomWidth"), 10) || 0) + (parseInt(s.css("marginTop"), 10) || 0)};
            ...
            if (this.options.values && this.options.values.length) {
                ...
                if (n !== this.values(t)) {
                    i = this.values();
                    i[t] = n;
                    s = this._trigger("slide", e, {handle: this.handles[t], value: n, values: i});
                    r = this.values(t ? 0 : 1);
                    s !== !1 && this.values(t, n, !0)
                }
            } else if (n !== this.value()) {
                s = this._trigger("slide", e, {handle: this.handles[t], value: n});
                s !== !1 && this.value(n)
            }
        }, _stop: function(e, t) {
            var n = {handle: this.handles[t], value: this.value()};
            ...
            if (this.options.values && this.options.values.length)
                this.handles.each(function(r) {
                    ...
                    if (a.options.range === !0)
                        if (a.orientation === "horizontal") {
                            r === 0 && a.range.stop(1, 1)[f ? "animate" : "css"]({left: n + "%"}, u.animate);
                            r === 1 && a.range[f ? "animate" : "css"]({width: n - t + "%"}, {queue: !1, duration: u.animate})
                        } else {
                            r === 0 && a.range.stop(1, 1)[f ? "animate" : "css"]({bottom: n + "%"}, u.animate);
