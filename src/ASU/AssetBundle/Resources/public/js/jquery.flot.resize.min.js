...
(function(e) {
    function r(n) {
        function r(n, r) {
            function i() {
                var r = n.getPlaceholder();
                if (r.width() == 0 || r.height() == 0)
                    return;
                ++t;
                e.plot(r, n.getData(), n.getOptions());
                --t
            }
            t || n.getPlaceholder().resize(i)
        }
        n.hooks.bindEvents.push(r)
    }
    var t = 0, n = {};
    e.plot.plugins.push({init: r, options: n, name: "resize", version: "1.0"})
})(jQuery);