 ...
 */(function(e, t, n) {
    ...
    function s(t, n, r, s) {
        if (Object.defineProperty)
            try {
                Object.defineProperty(t, n, {configurable: !0, enumerable: !0, get: function() {
                        i(s);
                        return r
                    }, set: function(e) {
                        i(s);
    ...
    var o = {}, u = e.attr, a = e.attrHooks.value && e.attrHooks.value.get || function() {
        return null
    ...
    e.attr = function(t, r, s, o) {
        var a = r.toLowerCase(), f = t && t.nodeType;
        if (o && u.length < 4) {
        ...
        if (!e.attrHooks[a] && h.test(a)) {
            e.attrHooks[a] = {get: function(t, r) {
                    var i, s = e.prop(t, r);
    ...
    e.event.trigger = function(e, t, n, r) {
        !n & !A.test(e) && i("Global events are undocumented and deprecated");
