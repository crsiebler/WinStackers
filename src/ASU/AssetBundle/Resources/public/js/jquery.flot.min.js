...
(function(e) {
    function t(t, r, s, o) {
        ...
        function T() {
            for (var t = 0; t < o.length; ++t) {
                var n = o[t];
                n.init(S);
                n.options && e.extend(!0, a, n.options)
            }
        }
        function N(t) {
            var n;
            e.extend(!0, a, t);
            a.xaxis.color == null && (a.xaxis.color = a.grid.color);
            a.yaxis.color == null && (a.yaxis.color = a.grid.color);
            a.xaxis.tickColor == null && (a.xaxis.tickColor = a.grid.tickColor);
            a.yaxis.tickColor == null && (a.yaxis.tickColor = a.grid.tickColor);
            ...
            for (n = 0; n < Math.max(1, a.xaxes.length); ++n)
                a.xaxes[n] = e.extend(!0, {}, a.xaxis, a.xaxes[n]);
            for (n = 0; n < Math.max(1, a.yaxes.length); ++n)
                a.yaxes[n] = e.extend(!0, {}, a.yaxis, a.yaxes[n]);
            ...
            for (n = 0; n < a.xaxes.length; ++n)
                _(d, n + 1).options = a.xaxes[n];
            for (n = 0; n < a.yaxes.length; ++n)
                _(v, n + 1).options = a.yaxes[n];
            for (var r in E)
                a.hooks[r] && a.hooks[r].length && (E[r] = E[r].concat(a.hooks[r]));
        ...
        function _(t, n) {
            t[n - 1] || (t[n - 1] = {n: n, direction: t == d ? "x" : "y", options: e.extend(!0, {}, t == d ? a.xaxis : a.yaxis)});
            return t[n - 1]
        }
        function D() {
            ...
            for (t = 0; t < u.length; ++t) {
                ...
                if (s != null) {
                    --n;
                    typeof s == "number" ? i.push(s) : r.push(e.color.parse(u[t].color))
                }
            }
            ...
            while (o.length < n) {
                var l;
                a.colors.length == t ? l = e.color.make(100, 100, 100) : l = e.color.parse(a.colors[t]);
                var c = f % 2 == 1 ? -1 : 1;
            ...
            for (t = 0; t < u.length; ++t) {
                ...
                if (p.color == null) {
                    ...
                    typeof p.color == "number" && (p.color = o[p.color].toString());
            ...
            for (i = 0; i < u.length; ++i) {
                ...
                if (!S) {
                    ...
                    if (l.bars.show || l.lines.show && l.lines.fill) {
                        S.push({y: !0, number: !0, required: !1, defaultValue: 0});
                ...
                for (s = o = 0; s < w.length; ++s, o += h) {
                    ...
                    else if (insertSteps && o > 0 && c[o - h] != null && c[o - h] != c[o] && c[o - h + 1] != c[o + 1]) {
                        for (a = 0; a < h; ++a)
                            c[o + h + a] = c[o + a];
                        c[o + 1] = c[o - h + 1];
                        o += h
        ...
        function H(n, r) {
            ...
            i.width = g;
            i.height = y;
            n || e(i).css({position: "absolute", left: 0, top: 0});
            e(i).appendTo(t);
            i.getContext || (i = window.G_vmlCanvasManager.initElement(i));
        ...
        function B() {
            ...
            y = t.height();
            if (g <= 0 || y <= 0)
                throw"Invalid dimensions for plot, width = " + g + ", height = " + y
        }
        function j(e) {
            e.width != g && (e.width = g);
            e.height != y && (e.height = y);
        ...
        function U(n) {
            ...
            if (n.direction == "x") {
                a == null && (a = Math.floor(g / (s.length > 0 ? s.length : 1)));
                if (f == null) {
                    o = [];
                    for (i = 0; i < s.length; ++i) {
                        u = s[i].label;
                        u && o.push('<div class="tickLabel" style="float:left;width:' + a + 'px">' + u + "</div>")
                    }
                    if (o.length > 0) {
                ...
                for (i = 0; i < s.length; ++i) {
                    u = s[i].label;
                    u && o.push('<div class="tickLabel">' + u + "</div>")
                }
                if (o.length > 0) {
                    l = c(o, "");
                    a == null && (a = l.children().width());
                    f == null && (f = l.find("div.tickLabel").height());
                    l.remove()
                }
            }
            a == null && (a = 0);
        ...
        function z(t) {
            var n = t.labelWidth, r = t.labelHeight, i = t.options.position, s = t.options.tickLength, o = a.grid.axisMargin, u = a.grid.labelMargin, f = t.direction == "x" ? d : v, l, c = e.grep(f, function(e) {
        ...
        function J(t) {
            var r = t.options, i;
            typeof r.ticks == "number" && r.ticks > 0 ? i = r.ticks : i = .3 * Math.sqrt(t.direction == "x" ? g : y);
            var s = (t.max - t.min) / i, o, u, a, f, l, c, h;
            if (r.mode == "time") {
                var p = {second: 1e3, minute: 6e4, hour: 36e5, day: 864e5, month: 2592e6, year: 525949.2 * 60 * 1e3}, m = [[1, "second"], [2, "second"], [5, "second"], [10, "second"], [30, "second"], [1, "minute"], [2, "minute"], [5, "minute"], [10, "minute"], [30, "minute"], [1, "hour"], [2, "hour"], [4, "hour"], [8, "hour"], [12, "hour"], [1, "day"], [2, "day"], [3, "day"], [.25, "month"], [.5, "month"], [1, "month"], [2, "month"], [3, "month"], [6, "month"], [1, "year"]], b = 0;
                r.minTickSize != null && (typeof r.tickSize == "number" ? b = r.tickSize : b = r.minTickSize[0] * p[r.minTickSize[1]]);
                for (var l = 0; l < m.length - 1; ++l)
                    if (s < (m[l][0] * p[m[l][1]] + m[l + 1][0] * p[m[l + 1][1]]) / 2 && m[l][0] * p[m[l][1]] >= b)
                        break;
                o = m[l][0];
                a = m[l][1];
                if (a == "year") {
                    ...
                    h = s / p.year / c;
                    h < 1.5 ? o = 1 : h < 3 ? o = 2 : h < 7.5 ? o = 5 : o = 10;
                    o *= c
                }
                t.tickSize = r.tickSize || [o, a];
                u = function(e) {
                    var t = [], r = e.tickSize[0], i = e.tickSize[1], s = new Date(e.min), o = r * p[i];
                    i == "second" && s.setUTCSeconds(n(s.getUTCSeconds(), r));
                    i == "minute" && s.setUTCMinutes(n(s.getUTCMinutes(), r));
                    i == "hour" && s.setUTCHours(n(s.getUTCHours(), r));
                    i == "month" && s.setUTCMonth(n(s.getUTCMonth(), r));
                    i == "year" && s.setUTCFullYear(n(s.getUTCFullYear(), r));
                    s.setUTCMilliseconds(0);
                    o >= p.minute && s.setUTCSeconds(0);
                    o >= p.hour && s.setUTCMinutes(0);
                    o >= p.day && s.setUTCHours(0);
                    o >= p.day * 4 && s.setUTCDate(1);
                    o >= p.year && s.setUTCMonth(0);
                    ...
                    do {
                        ...
                        if (i == "month")
                            ...
                            i == "year" ? s.setUTCFullYear(s.getUTCFullYear() + r) : s.setTime(a + o)
                    } while (a < e.max && a != f);
                    return t
                };
                f = function(t, n) {
                    ...
                    var s = n.tickSize[0] * p[n.tickSize[1]], o = n.max - n.min, u = r.twelveHourClock ? " %p" : "";
                    s < p.minute ? fmt = "%h:%M:%S" + u : s < p.day ? o < 2 * p.day ? fmt = "%h:%M" + u : fmt = "%b %d %h:%M" + u : s < p.month ? fmt = "%b %d" : s < p.year ? o < p.year ? fmt = "%b" : fmt = "%b %y" : fmt = "%y";
                    return e.plot.formatDate(i, fmt, r.monthNames)
                }
            } else {
                var w = r.tickDecimals, E = -Math.floor(Math.log(s) / Math.LN10);
                w != null && E > w && (E = w);
                c = Math.pow(10, -E);
                h = s / c;
                if (h < 1.5)
                    ...
                    h < 7.5 ? o = 5 : o = 10;
                o *= c;
                r.minTickSize != null && o < r.minTickSize && (o = r.minTickSize);
            ...
            if (r.alignTicksWithAxis != null) {
                ...
                if (S && S.used && S != t) {
                    var x = u(t);
                    if (x.length > 0) {
                        r.min == null && (t.min = Math.min(t.min, x[0]));
                        r.max == null && x.length > 1 && (t.max = Math.max(t.max, x[x.length - 1]))
                    }
                    u = function(e) {
                        var t = [], n, r;
                    ...
                    if (t.mode != "time" && r.tickDecimals == null) {
                        ...
                        N.length > 1 && /\..*0$/.test((N[1] - N[0]).toFixed(T)) || (t.tickDecimals = T)
                    }
                }
            }
            t.tickGenerator = u;
        ...
        function K(t) {
            ...
            for (i = 0; i < r.length; ++i) {
                ...
                isNaN(s) || t.ticks.push({v: s, label: o})
            }
        }
        function Q(e, t) {
        ...
        function G() {
            h.clearRect(0, 0, g, y);
            var e = a.grid;
            e.show && e.backgroundColor && Z();
            e.show && !e.aboveData && et();
        ...
        function et() {
            ...
            if (n) {
                ...
                for (t = 0; t < n.length; ++t) {
                    ...
                    s.from == null && (s.from = s.axis.min);
                    s.to == null && (s.to = s.axis.max);
                    o.from == null && (o.from = o.axis.min);
                    o.to == null && (o.to = o.axis.max);
            ...
            for (var f = 0; f < r.length; ++f) {
                ...
                if (l.direction == "x") {
                    d = 0;
                    p == "full" ? v = l.position == "top" ? 0 : w : v = c.top - m.top + (l.position == "top" ? c.height : 0)
                } else {
                    v = 0;
                    p == "full" ? d = l.position == "left" ? 0 : b : d = c.left - m.left + (l.position == "left" ? c.width : 0)
                }
                if (!l.innermost) {
                    h.beginPath();
                    g = y = 0;
                    l.direction == "x" ? g = b : y = w;
                    if (h.lineWidth == 1) {
                        d = Math.floor(d) + .5;
                        v = Math.floor(v) + .5
                    }
                ...
                for (t = 0; t < l.ticks.length; ++t) {
                    var E = l.ticks[t].v;
                    g = y = 0;
                    if (E < l.min || E > l.max || p == "full" && u > 0 && (E == l.min || E == l.max))
                        continue;
                    if (l.direction == "x") {
                        d = l.p2c(E);
                        y = p == "full" ? -w : p;
                    ...
                    h.lineWidth == 1 && (l.direction == "x" ? d = Math.floor(d) + .5 : v = Math.floor(v) + .5);
                    h.moveTo(d, v);
                    h.lineTo(d + g, v + y)
                }
                h.stroke()
        ...
        function tt() {
            ...
            var e = ['<div class="tickLabels" style="font-size:smaller">'], n = A();
            for (var r = 0; r < n.length; ++r) {
                ...
                for (var o = 0; o < i.ticks.length; ++o) {
                    ...
                    if (i.direction == "x") {
                        ...
                        i.position == "bottom" ? a.top = s.top + s.padding : a.bottom = y - (s.top + s.height - s.padding)
                    } else {
        ...
        function it(e) {
            ...
            h.lineWidth = n;
            h.strokeStyle = e.color;
            t(e.datapoints, i, ut(e.points, e.color), 0, !1, e.xaxis, e.yaxis, s);
            h.restore()
        }
        ...
        function at() {
            ...
            if (!a.legend.show)
                return;
            var n = [], r = !1, i = a.legend.labelFormatter, s, o;
            ...
            if (a.legend.container != null)
                e(a.legend.container).html(l);
            else {
                var c = "", h = a.legend.position, p = a.legend.margin;
                p[0] == null && (p = [p, p]);
                h.charAt(0) == "n" ? c += "top:" + (p[1] + m.top) + "px;" : h.charAt(0) == "s" && (c += "bottom:" + (p[1] + m.bottom) + "px;");
                h.charAt(1) == "e" ? c += "right:" + (p[0] + m.right) + "px;" : h.charAt(1) == "w" && (c += "left:" + (p[0] + m.left) + "px;");
                ...
                if (a.legend.backgroundOpacity != 0) {
                    ...
                    if (v == null) {
                        ...
                        v && typeof v == "string" ? v = e.color.parse(v) : v = e.color.extract(d, "background-color");
                        v.a = 1;
                        v = v.toString()
                    }
                    var g = d.children();
        ...
        function ct(e, t, n) {
            var r = a.grid.mouseActiveRadius, i = r * r + 1, s = null, o = !1, f, l;
            for (f = u.length - 1; f >= 0; --f) {
                ...
                h.options.inverseTransform && (y = Number.MAX_VALUE);
                p.options.inverseTransform && (b = Number.MAX_VALUE);
            ...
            if (s) {
                ...
                return{datapoint: u[f].datapoints.points.slice(l * v, (l + 1) * v), dataIndex: l, series: u[f], seriesIndex: f}
            }
            return null
        }
        function ht(e) {
            a.grid.hoverable && vt("plothover", e, function(e) {
        ...
        function vt(e, n, r) {
            ...
            if (a.grid.autoHighlight) {
                for (var l = 0; l < ft.length; ++l) {
                    var h = ft[l];
                    h.auto == e && (!f || h.series != f.series || h.point[0] != f.datapoint[0] || h.point[1] != f.datapoint[1]) && bt(h.series, h.point)
                }
                f && yt(f.series, f.datapoint, e)
            }
            t.trigger(e, [u, f])
        }
        function mt() {
            lt || (lt = setTimeout(gt, 30))
        }
        function gt() {
            lt = null;
            p.save();
            ...
            for (e = 0; e < ft.length; ++e) {
                t = ft[e];
                t.series.bars.show ? St(t.series, t.point) : Et(t.series, t.point)
            }
            p.restore();
            x(E.drawOverlay, [p])
        }
        ...
        function Et(t, n) {
            ...
            p.beginPath();
            t.points.symbol == "circle" ? p.arc(r, i, a, 0, 2 * Math.PI, !1) : t.points.symbol(p, r, i, a, !1);
            p.closePath();
            p.stroke()
        }
        function St(t, n) {
        ...
        S.pointOffset = function(e) {
            return{left: parseInt(d[L(e, "x") - 1].p2c(+e.x) + m.left), top: parseInt(v[L(e, "y") - 1].p2c(+e.y) + m.top)}
        };
        S.shutdown = q;
        S.resize = function() {
            B();
    ...
    e.plot.formatDate = function(e, t, n) {
        ...
        n == null && (n = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"]);
        t.search(/%p|%P/) != -1 && (u > 12 ? u -= 12 : u == 0 && (u = 12));
