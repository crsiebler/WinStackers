...
$(document).ready(function() {
    ...
    $(".chart").length > 0 && $(".chart").each(function() {
        ...
        t.easyPieChart({animate: 1e3, barColor: e, lineWidth: 3})
    });
    if ($(".calendar").length > 0) {
        $(".calendar").fullCalendar({header: {left: "today,prev,next", center: "title", right: "month,agendaWeek,agendaDay"}, buttonText: {today: "Today"}, editable: !0});
    ...
    $(".notify").click(function() {
        var e = $(this), t = e.attr("data-notify-title"), r = e.attr("data-notify-message"), i = e.attr("data-notify-image"), s = e.attr("data-notify-time"), o = e.attr("data-notify-sticky");
        if ($(".notify-toggle").hasClass(n)) {
            e.hasClass("notify-inverse") ? r = r.replace("{{state}}", e.hasClass("button-active") ? "on" : "off") : r = r.replace("{{state}}", e.hasClass("button-active") ? "off" : "on");
            $.gritter.add({title: typeof t != "undefined" ? t : "Message - Head", text: typeof r != "undefined" ? r : "Body", image: typeof i != "undefined" ? i : null, sticky: typeof o != "undefined" ? o : !1, time: typeof s != "undefined" ? s : 5e3})
        }
    });
    ...
    if ($(".plupload").length > 0) {
        $(".plupload").pluploadQueue({runtimes: "html5,gears,flash,silverlight,browserplus", url: "js/plupload/upload.php", max_file_size: "10mb", chunk_size: "1mb", unique_names: !0, resize: {width: 320, height: 240, quality: 90}, filters: [{title: "Image files", extensions: "jpg,gif,png"}, {title: "Zip files", extensions: "zip"}], flash_swf_url: "js/plupload/plupload.flash.swf", silverlight_xap_url: "js/plupload/plupload.silverlight.xap"});
    ...
    $(".form-wizard").length > 0 && $(".form-wizard").formwizard({formPluginEnabled: !0, validationEnabled: !0, focusFirstInput: !1, validationOptions: {errorElement: "span", errorClass: "help-block error", errorPlacement: function(e, t) {
            ...
            }}, formOptions: {success: function() {
            }, beforeSubmit: function() {
            }, dataType: "json", resetForm: !0}});
    $(".form-validate").length > 0 && $(".form-validate").each(function() {
        var e = $(this).attr("id");
        $("#" + e).validate({errorElement: "span", errorClass: "help-block error", errorPlacement: function(e, t) {
                t.parents(".controls").append(e)
            }, highlight: function(e) {
                $(e).closest(".control-group").removeClass("error success").addClass("error")
            }, success: function(e) {
    ...
    $(".dataTable").length > 0 && $(".dataTable").each(function() {
        var e = {sPaginationType: "full_numbers", oLanguage: {sSearch: "<span>Search:</span> ", sInfo: "Showing <span>_START_</span> to <span>_END_</span> of <span>_TOTAL_</span> entries", sLengthMenu: "<span>Show entries:</span> _MENU_"}};
    ...
    resize_chosen();
    $(".file-manager").length > 0 && $(".file-manager").elfinder({url: "js/elfinder/php/connector.php"});
    $(".slider").length > 0 && $(".slider").each(function() {
        var e = $(this), t = parseInt(e.attr("data-min")), n = parseInt(e.attr("data-max")), r = parseInt(e.attr("data-step")), i = e.attr("data-range"), s = parseInt(e.attr("data-rangestart")), o = parseInt(e.attr("data-rangestop")), u = {min: t, max: n, step: r, slide: function(t, n) {
        ...
        if (i !== undefined) {
            ...
            e.find(".amount").html(e.slider("value"))
    })
});
