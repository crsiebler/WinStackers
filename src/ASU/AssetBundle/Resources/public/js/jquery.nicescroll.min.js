/* jquery.nicescroll 3.1.0 InuYaksa*2012 MIT http://areaaperta.com/nicescroll */(function(e) {
    var r = false, w = false, B = 5E3, C = 2E3, D = function() {
        ...
        this.delayed = function(d, c, f, g) {
            ...
            if (e && e.last + f > h && !e.tt)
                b.delaylist[d] = {last: h + f, tt: setTimeout(function() {
                        b.delaylist[d].tt =
                                0;
                        c.call()
                    }, f)};
        ...
        this.updateScrollBar = function(d) {
            if (b.ishwscroll)
                ...
                if (b.railh && !b.locked)
                    f = c.top, g = c.left, d = b.railh.align ? f + h(b.win, "border-top-width", true) + b.win.innerHeight() - b.railh.height : f + h(b.win, "border-top-width", true), g += h(b.win, "border-left-width"), b.railh.css({top: d, left: g,
                        width: b.railh.width})
            }
        };
        ...
        this.init = function() {
            ...
            if (!b.ispage || !g.cantouch && !g.isieold && !g.isie9mobile) {
                ...
                for (y in j)
                    i = j[y], (h = b.opt.railpadding[i]) ? f.css("padding-" + i, h + "px") : b.opt.railpadding[i] = 0;
                f.append(c);
                ...
                if (b.ispage)
                    f.css({position: "fixed", top: "0px", height: "100%"}), f.align ? f.css({right: "0px"}) : f.css({left: "0px"}),
                            b.body.append(f), b.railh && (k.css({position: "fixed", left: "0px", width: "100%"}), k.align ? k.css({bottom: "0px"}) : k.css({top: "0px"}), b.body.append(k));
                else {
                    if (b.ishwscroll)
                        b.win.css("position") == "static" && b.css(b.win, {position: "relative"}), d = b.win[0].nodeName == "HTML" ? b.body : b.win, b.zoom && (b.zoom.css({position: "absolute", top: 1, right: 0, "margin-right": f.width + 4}), d.append(b.zoom)), f.css({position: "absolute", top: 0}), f.align ? f.css({right: 0}) : f.css({left: 0}), d.append(f), k && (k.css({position: "absolute", left: 0, bottom: 0}),
                ...
                if (g.isie9mobile)
                    b.scrollmom = new z(b), b.onmangotouch = function() {
                        ...
                        if (Math.round(Math.sqrt(Math.pow(l, 2) + Math.pow(f, 2))) != 0) {
                            ...
                            if (h - b.mangotouch.tm > 80 || b.mangotouch.dry != g || b.mangotouch.drx != e)
                                b.scrollmom.stop(),
                            ...
                            else if (b.scrollmom.stop(), b.scrollmom.update(b.mangotouch.sx - l, b.mangotouch.sy - f), b.mangotouch.tm = h, f = Math.max(Math.abs(b.mangotouch.ly - d), Math.abs(b.mangotouch.lx - c)), b.mangotouch.ly = d, b.mangotouch.lx = c, f > 2)
                    ...
                    if (g.cantouch || b.istouchcapable || b.opt.touchbehavior || g.hasmstouch) {
                        ...
                        b.ontouchstart = function(d) {
                            ...
                            if (!b.locked) {
                                ...
                                if (b.forcescreen)
                                    f = d, d = {original: d.original ? d.original : d}, d.clientX = f.screenX, d.clientY = f.screenY;
                                ...
                                if (!g.cantouch && !this.istouchcapable && !g.hasmstouch) {
                                    if (!c || !/INPUT|SELECT|TEXTAREA/i.test(c.nodeName))
                                        return!b.ispage && g.hasmousecapture && c.setCapture(), b.cancelEvent(d);
                        ...
                        b.ontouchend = function(d) {
                            if (d.pointerType && d.pointerType != 2)
                                return false;
                            if (b.rail.drag &&
                                    b.rail.drag.pt == 2 && (b.scrollmom.doMomentum(), b.rail.drag = false, b.hasmoving && (b.hasmoving = false, b.lastmouseup = true, b.hideCursor(), g.hasmousecapture && document.releaseCapture(), !g.cantouch)))
                                return b.cancelEvent(d)
                        };
                        ...
                        b.ontouchmove = function(d, c) {
                            ...
                            if (b.rail.drag && b.rail.drag.pt == 2) {
                                ...
                                if (b.ishwscroll && b.opt.bouncescroll)
                                    i < 0 ? i = Math.round(i / 2) : i > b.page.maxh && (i = b.page.maxh +
                                ...
                                if (b.railh && b.railh.scrollable) {
                                    ...
                                    if (b.ishwscroll && b.opt.bouncescroll)
                                        j < 0 ? j = Math.round(j / 2) : j > b.page.maxw && (j = b.page.maxw + Math.round((j - b.page.maxw) / 2));
                                ...
                                if (!g.ischrome && !b.istouchcapable)
                                    return b.cancelEvent(d)
                            }
                        }
                    }
                    g.cantouch || b.opt.touchbehavior ? (b.onpreventclick = function(d) {
                        ...
                        if (b.rail.drag && (g.hasmousecapture && document.releaseCapture(), b.isiframe && !g.hasmousecapture && b.doc.css("pointer-events", b.saved.csspointerevents), b.rail.drag.pt == 1))
                            return b.rail.drag = false, b.cancelEvent(d)
                    }, b.onmousemove = function(d) {
                        if (b.rail.drag) {
                            if (b.rail.drag.pt == 1) {
                                if (g.ischrome && d.which == 0)
                    ...
                    b.railh && (b.bind(b.cursorh, "mousedown", function(d) {
                        ...
                        if (!(b.rail.drag && b.rail.drag.pt == 2))
                            return b.rail.drag = false, b.hasmoving = false, b.hideCursor(), g.hasmousecapture && document.releaseCapture(), b.cancelEvent(d)
                    }));
            ...
            if (this.doc[0].nodeName == "IFRAME") {
                var A = function() {
                    ...
                    b.forcescreen = true;
                    if (b.isiframe)
                        b.iframe = {doc: e(d), html: b.doc.contents().find("html")[0], body: b.doc.contents().find("body")[0]}, b.getContentSize = function() {
        ...
        this.showCursor = function(d, c) {
            ...
            if (b.rail) {
                if (b.autohidedom)
                    b.autohidedom.stop().css({opacity: b.opt.cursoropacitymax}), b.cursoractive = true;
            ...
            if (!b.cursortimeout && b.rail && b.autohidedom)
                b.cursortimeout = setTimeout(function() {
                    if (!b.rail.active || !b.showonmouseevent)
                        b.autohidedom.stop().animate({opacity: b.opt.cursoropacitymin}), b.zoom && b.zoom.stop().animate({opacity: b.opt.cursoropacitymin}), b.cursoractive =
                                false;
                    b.cursortimeout = 0
                }, d || 400)
        };
        ...
        this.getViewport = function(b) {
            for (b = b && b.parentNode ? b.parentNode : false; b && b.nodeType == 1 && !/BODY|HTML/.test(b.nodeName); ) {
                var c = e(b);
                if (/scroll|auto/.test(c.css("overflowY") || c.css("overflowX") || c.css("overflow") || "") && b.clientHeight != b.scrollHeight)
                    return c;
        ...
        b.opt.smoothscroll ? b.ishwscroll && g.hastransition && b.opt.usetransition ? (this.prepareTransition = function(c, e) {
            ...
            function f() {
                ...
                if (b.dst.ay) {
                    ...
                    if (e < 0 && d < b.newscrolly || e > 0 && d > b.newscrolly)
                        d = b.newscrolly;
                    b.setScrollTop(d);
                    d == b.newscrolly && (c = 1)
                } else
                ...
                if (b.dst.ax) {
                    ...
                    e = g - sx;
                    if (e < 0 && g < b.newscrollx || e > 0 && g > b.newscrollx)
                        g = b.newscrollx;
                    b.setScrollLeft(g);
                    g == b.newscrollx && (c += 1)
                } else
        ...
        this.doScrollLeftBy =
                function(c, e) {
                    ...
                    if (f < 0 && px <= 0)
                        return b.noticeCursor();
                    else if (f > b.page.maxw && px >= b.page.maxw)
                        return b.noticeCursor();
                    b.doScrollLeft(f)
                };
        ...
        this.doZoomOut = function(c) {
            if (b.zoomactive)
                return b.zoomactive = false, b.win.css("margin", ""), b.win.css(b.zoomrestore.style), g.isios4 && e(window).scrollTop(b.zoomrestore.scrollTop), b.rail.css({"z-index": b.ispage ?
            ...
            if (c.speedy && b && c.speedy || e) {
                ...
                var d = c.lastscrollx, l = c.lastscrolly, f = function() {
                    ...
                    if (c.speedx && (d = Math.floor(c.lastscrollx - c.speedx * (1 - c.demulxy)), c.lastscrollx = d, d < 0 || d > m))
                        b = 0.1;
                    if (c.speedy && (l = Math.floor(c.lastscrolly - c.speedy * (1 - c.demulxy)), c.lastscrolly = l, l < 0 || l > g))
                        b = 0.1;
