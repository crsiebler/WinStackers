 ...
 */
        CKEDITOR.dialog.add("textfield", function(b) {
            ...
            return{title: b.lang.forms.textfield.title, minWidth: 350, minHeight: 150, onShow: function() {
                    ...
                    if (a && "input" == a.getName() && (g[a.getAttribute("type")] ||
                            !a.getAttribute("type")))
                    ...
                    this.foreach(function(a) {
                        if (a.getValue && (a.setup || (a.setup = f), !a.commit))
                            a.commit = e
                    })
                }, contents: [{id: "info", label: b.lang.forms.textfield.title, title: b.lang.forms.textfield.title,
                        elements: [{type: "hbox", widths: ["50%", "50%"], children: [{id: "_cke_saved_name", type: "text", label: b.lang.forms.textfield.name, "default": "", accessKey: "N", setup: function(a) {
                                        ...
                                        validate: CKEDITOR.dialog.validate.integer(b.lang.common.validateNumberFailed)}], onLoad: function() {
                                    ...
                                    if (CKEDITOR.env.ie) {
                                        ...
                                        c.setAttribute("type", this.getValue())
                                }}]}]}
        });