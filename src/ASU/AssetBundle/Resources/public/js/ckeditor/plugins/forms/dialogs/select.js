        ...
        CKEDITOR.dialog.add("select", function(c) {
            function h(a, b, e, d, c) {
                ...
                if (a && d && "option" == d.getName())
                    CKEDITOR.env.ie ? (isNaN(parseInt(c, 10)) ? a.$.options.add(d.$) : a.$.options.add(d.$, c), d.$.innerHTML = 0 < b.length ? b : "", d.$.value = e) : (null !== c && c < a.getChildCount() ? a.getChild(0 > c ? 0 : c).insertBeforeMe(d) : a.append(d), d.setText(0 < b.length ? b : ""), d.setValue(e));
                else
                    return!1;
                return d
            }
                    ...
                    if (e && (a.insertElement(b), CKEDITOR.env.ie)) {
                        ...
                        setTimeout(function() {
                            d.selectBookmarks(c)
                                ...
                                style: "width:350px", "default": "", className: "cke_disabled", onLoad: function() {
                                    ...
                                    "clear" == a ? this.setValue("") : "option" == a && b.getAttribute("selected") && this.setValue(b.$.value)
                                }}, {type: "hbox", widths: ["175px", "170px"], children: [{id: "txtSize", type: "text", labelLayout: "horizontal", label: c.lang.forms.select.size, "default": "", accessKey: "S", style: "width:175px", validate: function() {
                                        ...
                                        }}, {type: "html", html: "<span>" + CKEDITOR.tools.htmlEncode(c.lang.forms.select.lines) + "</span>"}]}, {type: "html", html: "<span>" + CKEDITOR.tools.htmlEncode(c.lang.forms.select.opAvail) + "</span>"}, {type: "hbox", widths: ["115px",
                                    "115px", "100px"], children: [{type: "vbox", children: [{id: "txtOptName", type: "text", label: c.lang.forms.select.opText, style: "width:115px", setup: function(a) {
                                                ...
                                                }}]}, {type: "vbox", padding: 5, children: [{type: "button", id: "btnAdd", style: "", label: c.lang.forms.select.btnAdd, title: c.lang.forms.select.btnAdd, style:"width:100%;", onClick: function() {
                                                ...
                                                onClick: function() {
                                                    ...
                                                    j(b, 1, a.getParentEditor().document);
                                                    j(c, 1, a.getParentEditor().document)
                                                }}]}]}, {type: "hbox", widths: ["40%", "20%", "40%"], children: [{type: "button", id: "btnSetValue", label: c.lang.forms.select.btnSetValue, title: c.lang.forms.select.btnSetValue, onClick: function() {
